    ...
    <main id="main" class="main">
        <div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Haftalık En Çok Tıklananlar</h5>
                        <canvas id="weeklyChart" style="max-height: 400px;"></canvas>
                        <script>
                            document.addEventListener("DOMContentLoaded", () => {
                                const weeklyData = <%= new com.google.gson.Gson().toJson(ClassificationCounter.getWeeklyClassifications()) %>;
                                const labels = weeklyData.map(entry => entry.key);
                                const dataValues = weeklyData.map(entry => entry.value);
