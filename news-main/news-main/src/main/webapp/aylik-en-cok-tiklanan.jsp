...
<main id="main" class="main">
    <div class="d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Aylık En Çok Tıklananlar</h5>
                    <canvas id="monthlyChart" style="max-height: 400px;"></canvas>
                    <script>
                        document.addEventListener("DOMContentLoaded", () => {
                            const monthlyData = <%= new com.google.gson.Gson().toJson(ClassificationCounter.getMonthlyClassifications())%>;
                            const labels = monthlyData.map(entry => entry.key);
                            const dataValues = monthlyData.map(entry => entry.value);
