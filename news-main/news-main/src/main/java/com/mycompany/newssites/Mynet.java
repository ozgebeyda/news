...
public class Mynet {
    ...
    public void MynetCalis() {
        // Veritabanına bağlan
        database.connect();

        // site_id = 1 olan RSS linklerini al
        MongoCursor<Document> cursor = database.getRssLinks(12);
    ...
    private static String fetchArticleBody(String detailLink) {
        try {
            ...
            // Burada sınıf adına göre div seçimi yapıyoruz
            Element articleDiv = detailDoc.selectFirst("div.detail-content-inner");
