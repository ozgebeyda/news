...
public class Denizli24Haber {

    public static void main(String[] args) {
        Denizli24Haber d = new Denizli24Haber();
        d.Denizli24HaberCalis();
    }

    private static final Database database = new Database();

    public void Denizli24HaberCalis() {
        // Veritabanına bağlan
        database.connect();

        // site_id = 1 olan RSS linklerini al
        MongoCursor<Document> cursor = database.getRssLinks(4);
    ...
    private static String fetchArticleBody(String detailLink) {
        try {
            ...
            Element articleDiv = detailDoc.selectFirst("div.news-detail"); // Select the div with class "news-detail"
