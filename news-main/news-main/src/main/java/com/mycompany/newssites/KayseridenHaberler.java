...
public class KayseridenHaberler {
    ...
    public void KayseridenHaberlerCalis() {
        // Veritabanına bağlan
        database.connect();

        // site_id = 1 olan RSS linklerini al
        MongoCursor<Document> cursor = database.getRssLinks(10);
    ...
    private static String fetchArticleBody(String detailLink) {
        try {
            ...
            Element articleDiv = detailDoc.selectFirst("div.article-text.container-padding"); // Belirtilen div'i seç
