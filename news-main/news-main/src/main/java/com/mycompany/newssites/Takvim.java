...
public class Takvim {
    ...
    public void TakvimCalis() {
        ...
        MongoCursor<Document> cursor = database.getRssLinks(21);
    ...
    private static String fetchArticleBody(String detailLink) {
        try {
            ...
            Element leftSideDiv = detailDoc.selectFirst("div.col-12.col-lg-8.left-side");

            if (leftSideDiv != null) {
                return leftSideDiv.outerHtml();  // Div'in dış HTML içeriğini al
            } else {
