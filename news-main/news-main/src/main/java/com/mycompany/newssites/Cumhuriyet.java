...
public class Cumhuriyet {
    ...
    public static void main(String[] args) {
        Cumhuriyet c = new Cumhuriyet();
        c.CumhuriyetCalis();
    }

    private static final Database database = new Database();

    public void CumhuriyetCalis() {
        // Veritabanına bağlan
        database.connect();

        // site_id = 1 olan RSS linklerini al
        MongoCursor<Document> cursor = database.getRssLinks(3);
    ...
    private static String fetchArticleBody(String detailLink) {
        try {
            ...
            // Belirtilen sınıflara sahip div elementini seç
            Element articleDiv = detailDoc.selectFirst("div.col-sm-8.col-md-8.col-lg-8");
